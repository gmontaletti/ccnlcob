...
Versione 0.6.0: Fasi 1-5 completate, nessuno stub. Validato sulla slice
...
`giornate` sommate in doppia precisione. Manca il repository di workflow
`targets` (Fase 5) e i grafici (Fase 6). I default delle funzioni sulle
retribuzioni derivano dalla diagnostica su dati reali
